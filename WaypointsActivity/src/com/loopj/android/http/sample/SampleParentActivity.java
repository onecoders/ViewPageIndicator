...
public abstract class SampleParentActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        contents_scroll.setLayoutParams(new LinearLayout.LayoutParams(ViewGroup.LayoutParams.FILL_PARENT, ViewGroup.LayoutParams.FILL_PARENT));
    ...
    private void setupHeaders() {
        ...
        urlLayout.setLayoutParams(new LinearLayout.LayoutParams(ViewGroup.LayoutParams.FILL_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
